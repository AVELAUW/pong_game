...
class Pong(PyGameWrapper):
    ...
    def step(self, dt):
        ...
        pygame.draw.line(self.screen, (255,255,255), [self.width/2-1,0], [self.width/2-1,self.height], 3) # Draw the net
        ...
        self.screen.blit(text, (self.width/2+1,self.ball_radius) )
